...
data <- read.table("ppn_snipre_input.txt", header = TRUE)  # sample data set
...
write.table(res, file = "ppn_eb_results.csv", sep  = ",", row.names = FALSE)
...
write.table(bres, file = "ppn_bayesian_results.csv", sep  = ",", row.names = FALSE)